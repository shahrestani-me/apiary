...
# Moved to `observed.py` in #152 c1 and imported back, so that every caller and
# every test of them is unchanged by the split. The window is what #152 deletes;
# the recorder outlives it - see that module's docstring.
